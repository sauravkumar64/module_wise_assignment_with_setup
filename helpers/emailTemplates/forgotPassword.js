                    ...
                    <tr>
                        <td style=''>
                            <table cellspacing='0' cellpadding='0' style='padding:20px 20px; width:100%; box-sizing:border-box;'>
                                <tr>
                                    <td style='margin:0px;'>
                                        <h2 style='font-size:16px;font-weight:600;font-size:20px; color:#000; text-align:center;text-transform:uppercase;margin:0px; '>Reset password</h2></td>
                                </tr>
                                <tr>
                                <td bgcolor="#ffffff" align="left" style="padding: 20px 30px 10px 30px; color: #666666; font-family: Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;" >
                                ...
                                <td bgcolor="#ffffff" align="left" style="padding: 20px 30px 40px 30px; color: #666666; font-family: Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;" >
                                  <p style="margin: 0;">We received a request to change the password on this account. If you made this request, you can reset your password by using the following otp.</p>
                                </td>
                                </tr>
                                <tr>
